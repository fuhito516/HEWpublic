...
void cCamera::Update()
{
	...
	//{
	//	position.x -= cosf(rotation.y) * VALUE_DIRECTION_CAMERA;
	//	position.z += sinf(rotation.y) * VALUE_DIRECTION_CAMERA;
	...
	//{
	//	position.x += sinf(rotation.y) * VALUE_DIRECTION_CAMERA;
	//	position.z += cosf(rotation.y) * VALUE_DIRECTION_CAMERA;
	...
	//{
	//	position.y += VALUE_DIRECTION_CAMERA;
	//	lookAt.y  += VALUE_DIRECTION_CAMERA;
	//}
	//// 下移動
	...
	//{
	//	lookAt.y += VALUE_DIRECTION_CAMERA * 2;
	//}
	//// 注視点下移動

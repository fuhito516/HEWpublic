...
void cStage1::Init()
{
	...
	/*cHorizontalMoveGround::SetGround(D3DXVECTOR2(189,14.0f), D3DXVECTOR2(1.0f, 2.0f),D3DXVECTOR2(4.0f,0.0f));
	cHorizontalMoveGround::SetGround(D3DXVECTOR2(190, 14.0f), D3DXVECTOR2(1.0f, 2.0f), D3DXVECTOR2(4.0f, 0.0f));
	cHorizontalMoveGround::SetGround(D3DXVECTOR2(191, 14.0f), D3DXVECTOR2(1.0f, 2.0f), D3DXVECTOR2(4.0f, 0.0f));*/

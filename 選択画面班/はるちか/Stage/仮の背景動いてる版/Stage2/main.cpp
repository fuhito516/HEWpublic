...
bool Initialize(HINSTANCE hInstance)
{
	...
	//横移動床
	cMoveGround::MoveSetGround(D3DXVECTOR2(55, 1.0f), D3DXVECTOR2(10.0f, 2.0f));
	cMoveGround::MoveSetGround(D3DXVECTOR2(75, 1.0f), D3DXVECTOR2(10.0f, 2.0f));

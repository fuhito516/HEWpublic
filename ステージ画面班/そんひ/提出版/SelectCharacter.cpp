...
{
	Character1P = 1;                                                  //１Pの選択キャラクター
	Character2P = 1;                                                  //２Pの選択キャラクター
	Character3P = 1;                                                  //３Pの選択キャラクタ-
	Character4P = 1;
	Playercarsolu = (float)SCREEN_WIDTH / 32 * 4;                                      //カーソル座標の決定
	Playercarsolu2 = (float)SCREEN_WIDTH / 32 * 4;                                    //カーソル座標の決定
	Playercarsolu3 = (float)SCREEN_WIDTH / 32 * 4;                                      //カーソル座標の決定
